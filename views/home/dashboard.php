        ...
        <section class="bento-grid">
            ...
            <div class="bento-card">
                ...
                <div class="action-tiles">
                    <a href="<?= $base ?>order/index" class="action-tile" style="border-color: rgba(16, 185, 129, 0.4); background: rgba(16, 185, 129, 0.04);">
                        <div class="action-icon" style="background: rgba(16, 185, 129, 0.15); color: #059669;">
                            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                    ...
                    <a href="<?= $base ?>order/history" class="action-tile">
                        <div class="action-icon" style="background: rgba(37, 99, 235, 0.1); color: var(--blue);">
                            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                        ...
                        <div class="action-info">
                            ...
                            <p>Przeglądaj i pobieraj złożone zamówienia hurtowe</p>
                        </div>
                    </a>
